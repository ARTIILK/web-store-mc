                    ...
                    >
                        ...
                        <div className="flex-grow overflow-y-auto p-6 space-y-6">
                            {cart.length === 0 ? (
                                <div className="h-full flex flex-col items-center justify-center text-center opacity-50">
                                    ...
                                    <p className="text-sm">Add some ranks to get started!</p>
                                </div>
                            ) : (
                                cart.map((item) => (
                        ...
                        {cart.length > 0 && (
                            <div className="p-8 bg-white/[0.02] border-t border-white/10">
                                ...
                                <button className="w-full py-4 bg-gradient-to-r from-mc-gold to-mc-orange text-mc-dark font-black rounded-xl hover:shadow-[0_0_30px_rgba(245,158,11,0.4)] transition-all">
                                    Proceed to Checkout
                                </button>
